...
export const TURKEY_CITIES_DISTRICTS = {
...
export const CITIES = Object.keys(TURKEY_CITIES_DISTRICTS).sort();

export const getDistrictsByCity = (city: string): string[] => {
  return TURKEY_CITIES_DISTRICTS[city as keyof typeof TURKEY_CITIES_DISTRICTS] || [];
};